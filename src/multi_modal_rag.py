...
def retriever_image_prompt_func(data_dict):
    ...
    text_message = {
        ...
        "text": (
                    ...
                    "as well as a description of how the image relates to the question and text."
                    "output format: [[index=0,description=''],[index=1,description=''], [index=2,description='']]\n"
...
if __name__ == '__main__':
    ...
    '''run rag'''
    llm_text = ChatOpenAI(model="gpt-4-turbo",temperature=0)
    llm_multi_modal = ChatOpenAI(model="gpt-4-vision-preview",temperature=0)
    ...
    while True:
        ...
        if retriever_image:
            ...
            # print('retriever_image:',retriever_image)
